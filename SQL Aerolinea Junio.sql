...
-- Volcando datos para la tabla bd_proyecto_aviones15.pagador: ~2 rows (aproximadamente)
DELETE FROM `pagador`;
...
INSERT INTO `pagador` (`CODIGO_PAGADOR`, `NIF`, `EMAIL`, `PASS`, `NOMBRE`, `APELLIDOS`, `FECHA_NAC`, `POBLACION`, `DIRECCION`) VALUES
	(8, '48152179T', 'carlos.93.gal@gmail.com', 'p7l6GXtud6I=', 'Carlos', 'Galdanez Tarancon', '1993-07-22', 'Villamalea', 'c/ Iniesta nÂº16');
...
-- Volcando datos para la tabla bd_proyecto_aviones15.pasajero: ~1 rows (aproximadamente)
...
INSERT INTO `pasajero` (`CODIGO_PASAJERO`, `TRATAMIENTO`, `NOMBRE`, `APELLIDOS`, `NIF`, `CADUCIDAD_NIF`, `FECHA_NAC`, `TIPO`) VALUES
	(11, 'Mr', 'Carlos', 'Galdanez Tarancon', '48152179T', '2021-07-09', '1993-07-22', 'adulto');
...
INSERT INTO `reserva` (`CODIGO_RESERVA`, `COD_VUELO_IDA`, `COD_VUELO_VUELTA`, `COD_RESERVA`, `TARJETA`, `NUMERO_VIAJEROS`, `PRECIO_TOTAL`, `FECHA`, `FACTURADA_IDA`, `FACTURADA_VUELTA`) VALUES
	(2, 47, NULL, 'ZRRCOC0K24', 2, 1, 50, '2017-06-05 00:28:17', 'N', NULL);
...
INSERT INTO `tarjeta` (`CODIGO_TARJETA`, `NUM_TARJETA`, `COD_PAGADOR`, `CODSEGURIDAD`, `CADUCIDAD`, `NUM_USOS`) VALUES
	(2, '8Mv9CB4sbwi/7B/yo0GXQw==5454', 8, 'agxAZ6a5scg=', '2019-02-08', 1);
...
INSERT INTO `vuelo` (`CODIGO_VUELO`, `CONEXION`, `FECHA`, `HORA_SALIDA`, `HORA_LLEGADA`, `DURACION`, `ASIENTOS_LIBRES`, `NUMERO`, `AVION`, `PRECIO`) VALUES
	(47, 19, '2017-07-20', '20:07:45', '21:07:54', '01:00:00', 11, 'AB0001', 'V001', 50),
