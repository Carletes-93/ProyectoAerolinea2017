 ...
 * @author Carlos
 */
public class controladorSacarTarjetas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            aTarjetas = objop.buscarTarjetas(Conex, p1);
            
            h="Hay tarjetas";
            
            if(aTarjetas.isEmpty()){
                h="No hay tarjetas";
            }
        ...
        if(h.equals("Hay tarjetas")){
            session.setAttribute("TarjetasPagador", aTarjetas);
