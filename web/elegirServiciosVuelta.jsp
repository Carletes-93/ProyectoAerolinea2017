<%-- 
    Document   : elegirServiciosVuelta
    Created on : 19-may-2016, 12:21:48
    Author     : Carlos
--%>
	...
	<!-- Main -->
		<div id="main">
			<div id="content" class="container">
				<section>
                                    <header>
                                        <h2>Elije los servicios del viaje de Vuelta</h2>
                                    </header>
                                    <div id="contenido">
                                        <form action="controladorServiciosPasajerosVuelta" name="form5">
                                            ...
                                            <% if(aPasajerosBebes != null){%>
                                                ...
                                                <% }%>
                                            <% }%>
                                            <button type="submit" class="accion" name="serviciospasajerosvuelta" value="serviciospasajerosvuelta">
                                                Continuar
                                            </button>
                                        </form>
                                    </div>
