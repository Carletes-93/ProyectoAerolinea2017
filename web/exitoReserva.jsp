<%-- 
    Document   : exitoReserva
    Created on : 06-jun-2016, 14:03:05
    Author     : Carlos
--%>
	...
	<!-- Main -->
		<div id="main">
			<div id="content" class="container">
				<section>
                                    <header>
                                        <h2>La reserva se ha completado con exito.</h2>
                                        <h1>¡Gracias por confiar en AB Airline!</h1>
                                    </header>
                                    <div class="contenidoresumen">
                                        <form action="controladorExitoReserva" name="form15">
                                            <button type="submit" class="accion" name="finalizar" value="finalizar">
                                                Finalizar
                                            </button>
                                        </form>
                                    </div>
