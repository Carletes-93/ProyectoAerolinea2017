<%-- 
    Document   : exitoVolar
    Created on : 09-mar-2017, 22:49:14
    Author     : Carlos
--%>
    ...
    <body>
        ...
        <div id="main">
            <div id="content" class="container">
                <section>
                    <header>
                        <h2>El vuelo ha aterrizado con exito.</h2>
                        <h1>¡Gracias por volar con AB Airline!</h1>
                    </header>
                    <div class="contenidoresumen">
                            <a href="finalizarVuelo.jsp"><button class="accion" name="finalizar" value="finalizar">Finalizar</button></a>
                    </div>
                </section>
            </div>
        </div>
