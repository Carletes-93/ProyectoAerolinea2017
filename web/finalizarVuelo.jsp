<%-- 
    Document   : finalizarVuelo
    Created on : 03-mar-2017, 10:47:59
    Author     : carlos
--%>
        ...
        <div id="main">
            <div id="content" class="container">
                <section>
                    ...
                    <div id="contenido">
                        <form action="controladorBuscarReservasVolar" name="form20">
                            <table class="tablafinvuelo">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="fecha" class="datepicker" size="20" required>
                                    </td>
                                </tr>
                            </table>
