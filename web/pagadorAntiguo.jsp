<%-- 
    Document   : pagadorAntiguo
    Created on : 01-jun-2016, 11:34:08
    Author     : Carlos
--%>
		...
		<div id="main">
			<div id="content" class="container">
				<section>
                                    ...
                                    <div id="contenido">
                                        <form action="controladorBuscarPagador" name="form8">
                                            ...
                                            <button type="submit" class="accion" name="pagadorantiguo" value="pagadorantiguo">
                                                Continuar
                                            </button>
                                        </form>
                                    </div>
